...
- [x] Англи хэл сонголт ✅ (`lib/i18n.js` — Navbar, Нүүр, форм, Жагсаалт, тухайн амьтны дэлгэрэнгүй хуудас (Share/Report/Sightings хамт) бүгд орчуулагдсан; Миний амьтад, Admin үлдсэн)
