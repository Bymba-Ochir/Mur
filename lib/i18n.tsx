...
const MN = {
  ...
  reward_label: 'Шагнал (₮, заавал биш)', reward_placeholder: '50000', reward_prefix: 'Шагнал',
...
const EN: Record<TranslationKey, string> = {
  ...
  reward_label: 'Reward (₮, optional)', reward_placeholder: '50000', reward_prefix: 'Reward',
