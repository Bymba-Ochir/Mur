...
const MN = {
  ...
  assistant_disclaimer: '⚠️ Энэ зөвлөгөө нь мэргэжлийн малын эмчийг орлохгүй. Хүнд шинж тэмдэг, яаралтай үед малын эмчид хандахыг зөвлөж байна.',
...
const EN: Record<TranslationKey, string> = {
  ...
  assistant_disclaimer: '⚠️ This advice does not replace a professional veterinarian. For serious symptoms or emergencies, please consult a vet.',
