...
export default function Home() {
  return (
    <div>
      ...
      <p style={{ color: '#6B7680', maxWidth: 480, marginBottom: 24 }}>
      ...
      <div style={{ marginTop: 48 }}>
        ...
        <div className="grid">
          <div style={{ background: '#fff', padding: 20, borderRadius: 14, border: '1px solid #E1E4DF' }}>
            <h3 style={{ fontSize: 16 }}>1. Бүртгэх</h3>
            <p style={{ color: '#6B7680', fontSize: 13.5, marginTop: 6 }}>
