  ...
  return (
    <div>
      ...
      <div className="filter-bar">
        <input type="search" className="filter" placeholder={t('sitting_search_placeholder')} value={search} onChange={(e) => setSearch(e.target.value)} />
        <select className="filter" value={petType} onChange={(e) => setPetType(e.target.value as SittingPetType | '')}>
